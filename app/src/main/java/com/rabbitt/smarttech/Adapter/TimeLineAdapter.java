...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineAdapter.holder> {
    ...
    public TimeLineAdapter(List<RecycleAdapter> productAdapter, MainFragment context, OnRecycleItemListener onRecycleItemListener) {
    ...
    @NonNull
    @Override
    public TimeLineAdapter.holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
